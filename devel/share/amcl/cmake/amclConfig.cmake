...
if("TRUE" STREQUAL "TRUE")
  set(amcl_SOURCE_PREFIX /home/siddharthqr/round1/src/navigation/amcl)
  set(amcl_DEVEL_PREFIX /home/siddharthqr/round1/devel/.private/amcl)
  set(amcl_INSTALL_PREFIX "")
  set(amcl_PREFIX ${amcl_DEVEL_PREFIX})
else()
  set(amcl_SOURCE_PREFIX "")
  set(amcl_DEVEL_PREFIX "")
  set(amcl_INSTALL_PREFIX /home/siddharthqr/round1/install)
...
if(NOT "/home/siddharthqr/round1/devel/.private/amcl/include;/home/siddharthqr/round1/src/navigation/amcl/include " STREQUAL " ")
  set(amcl_INCLUDE_DIRS "")
  set(_include_dirs "/home/siddharthqr/round1/devel/.private/amcl/include;/home/siddharthqr/round1/src/navigation/amcl/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'amcl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/siddharthqr/round1/src/navigation/amcl/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/siddharthqr/round1/devel/.private/amcl/lib;/home/siddharthqr/round1/devel/lib;/opt/ros/noetic/lib)
